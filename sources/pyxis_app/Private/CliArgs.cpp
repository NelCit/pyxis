...
void PrintUsage() noexcept {
  std::fputs(
      ...
      "                          (pass.RaytracedGBuffer, pass.Composite,\n"
      "                          frame.cpu.commitResources, p50/p99/max).\n"
      "                          0 = disabled (default).\n"
      ...
      "                          (see _tools/setup_dlss.py) — the only outcome v1 ever\n"
      "                          exercises; headless goldens are unaffected either way.\n"
      "\n"
      "Viewer extras:\n"
