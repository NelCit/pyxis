...
struct LightDesc {
  ...
  // §22.3 reserved padding. §43.1 reserves a `lightLinkSet` slot;
  // M9+ may add cone-spot params, IES profiles, area-light samplers.
  // Naming is §22.3 / §43 convention; see OpenPBRMaterialDesc.h for
  // the §30.2 NOLINT rationale.
